...
1. Open a fresh PowerShell terminal as Administrator and run the remote bootstrap script:
   ...
   This will automatically install core dependencies, prompt me to authenticate (GitHub, Bitwarden), clone this repository, and automatically launch `setup.ps1` to link configs, install apps, and register scheduled tasks.

> [!CAUTION]
> **Lenovo Legion Toolkit (LLT)** is installed automatically, but it **will not work** without the expected drivers. Make sure you install the **Lenovo Energy >Management** driver and **Lenovo Vantage Gaming Feature Driver** beforehand (usually pulled automatically via Windows Update or Lenovo Vantage).
