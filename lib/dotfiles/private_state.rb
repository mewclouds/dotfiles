...
module Dotfiles
    ...
    class PrivateState
        ...
        def retrieve_identity
            ...
            raise "Could not retrieve '#{BITWARDEN_ITEM_NAME}' from Bitwarden. The note is empty." if identity.empty?
        ...
        def vault_status
            raw_status = @runner.capture(%w[bw status])
